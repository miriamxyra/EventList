...
if ($EventList_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName EventList.Import.IndividualFiles -Fallback $false
if ($EventList_importIndividualFiles) { $importIndividualFiles = $true }
